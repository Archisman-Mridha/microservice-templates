...
func (m *SigninRequest) CloneVT() *SigninRequest {
	...
	if m.Id != nil {
		r.Id = m.Id.(interface{ CloneVT() isSigninRequest_Id }).CloneVT()
	}
...
func (m *SigninRequest_Email) CloneVT() isSigninRequest_Id {
	if m == nil {
...
func (m *SigninRequest_Username) CloneVT() isSigninRequest_Id {
	if m == nil {
...
func (this *SigninRequest) EqualVT(that *SigninRequest) bool {
	...
	if this.Id == nil && that.Id != nil {
		...
		if !this.Id.(interface{ EqualVT(isSigninRequest_Id) bool }).EqualVT(that.Id) {
			return false
		}
	}
...
func (this *SigninRequest_Email) EqualVT(thatIface isSigninRequest_Id) bool {
...
func (this *SigninRequest_Username) EqualVT(thatIface isSigninRequest_Id) bool {
...
func (m *SigninRequest) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if msg, ok := m.Id.(*SigninRequest_Username); ok {
	...
	if msg, ok := m.Id.(*SigninRequest_Email); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
...
func (m *SigninRequest) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Id = &SigninRequest_Email{Email: string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			m.Id = &SigninRequest_Username{Username: string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
...
func (m *SigninRequest) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Id = &SigninRequest_Email{Email: stringValue}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Username", wireType)
			...
			m.Id = &SigninRequest_Username{Username: stringValue}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Password", wireType)
